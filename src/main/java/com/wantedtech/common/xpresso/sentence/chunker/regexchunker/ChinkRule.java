...
public class ChinkRule extends RegexpChunkRule {
		String _pattern;
		/*
	        """
		 ...
		 * 
		 */
	    public ChinkRule(String tag_pattern, String descr) {
	        super(x.Regex("(?<chink>" + ChunkerStatic.tag_pattern2re_pattern(tag_pattern) +")" +  ChunkString.IN_CHUNK_PATTERN), "}${chink}{", descr);
