...
public class Equals {
     ...
     * @since 3.0
     */
    static boolean isRegistered(Set<Pair<IDKey,IDKey>> REGISTRY, final Object lhs, final Object rhs) {
     ...
     */
    static void register(Set<Pair<IDKey,IDKey>> REGISTRY, final Object lhs, final Object rhs) {
        final Pair<IDKey, IDKey> pair = getRegisterPair(lhs, rhs);
        REGISTRY.add(pair);
    }
    ...
    */
    ...
    public static boolean reflectionEquals(final Object lhs, final Object rhs, final boolean testTransients, final Class<?> reflectUpToClass,
    	...
    	EqualsResult result = new EqualsResult();
    	
        Set<Pair<IDKey, IDKey>> REGISTRY = new HashSet<Pair<IDKey, IDKey>>();
