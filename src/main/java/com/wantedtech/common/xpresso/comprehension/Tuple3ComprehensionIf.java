...
public class Tuple3ComprehensionIf {

	Tuple3Comprehension comprehension;
	
	public Tuple3ComprehensionIf(Tuple3Comprehension comprehension){
	...
	public Tuple3ComprehensionElse when(Predicate<Object> predicate){
		this.comprehension.when(predicate);
		return new Tuple3ComprehensionElse(this.comprehension);
	}
	public Tuple3ComprehensionElse unless(Predicate<Object> predicate){
