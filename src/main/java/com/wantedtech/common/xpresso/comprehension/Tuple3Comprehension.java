...
class Tuple3Comprehension extends AbstractTupleComprehension{
	
	public Tuple3Comprehension(String fieldName0, String fieldName1, String fieldName2){
		this.outputFieldNames.add(fieldName0);
		this.outputFieldNames.add(fieldName1);
		this.outputFieldNames.add(fieldName2);
	}
	...
	public void apply(Function<Object,?> function0,Function<Object,?> function1,Function<Object,?> function2){
		if(outputFieldNames.size() > this.if_functions.size()){
			if_functions.add(function0);
			if_functions.add(function1);
			if_functions.add(function2);
		}else{
			else_functions.add(function0);
			else_functions.add(function1);
			else_functions.add(function2);
		}
	}
	...
	public void replace(Object value0, Object value1, Object value2){
		if(outputFieldNames.size() > this.if_functions.size()){
			if_functions.add(x.constant(value0));
			if_functions.add(x.constant(value1));
			if_functions.add(x.constant(value2));
		}else{
			else_functions.add(x.constant(value0));
			else_functions.add(x.constant(value1));
			else_functions.add(x.constant(value2));
		}
	}
	...
	public void in(Iterable<?> elements){
		...
		for(Object element : elements){
			...
			if(outputFieldNames.get(2).equals("_")){
				index2 = elementFieldNames.size()-1;
			}else{
				index2 = elementFieldNames.indexOf(outputFieldNames.get(2));
			}
			if(if_predicate.apply(element)){
				if(element instanceof tuple){
					outputElement = x.tuple(if_functions.get(0).apply((((tuple)element).get(index0))),if_functions.get(1).apply((((tuple)element).get(index1))),if_functions.get(2).apply((((tuple)element).get(index2))));	
				}else if(element instanceof Iterable<?>){
					list<?> elementAsList = x.list((Iterable<?>)element); 
					outputElement = x.tuple(if_functions.get(0).apply((((list<?>)element).get(index0))),if_functions.get(1).apply(((elementAsList).get(index1))),if_functions.get(2).apply(((elementAsList).get(index2))));
				}else{
					outputElement = null;
				}
			}else{
				if(element instanceof tuple){
					outputElement = x.tuple(else_functions.get(0).apply((((tuple)element).get(index0))),else_functions.get(1).apply((((tuple)element).get(index1))),else_functions.get(2).apply((((tuple)element).get(index2))));	
				}else if(element instanceof Iterable<?>){
					list<?> elementAsList = x.list((Iterable<?>)element);
					outputElement = x.tuple(else_functions.get(0).apply((((list<?>)element).get(index0))),else_functions.get(1).apply(((elementAsList).get(index1))),else_functions.get(2).apply(((elementAsList).get(index2))));
				}else{
					outputElement = null;
				}
			}
