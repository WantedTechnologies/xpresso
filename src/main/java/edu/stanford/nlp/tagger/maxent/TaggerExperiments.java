...
import com.wantedtech.common.xpresso.sentence.pos.en.stanford.Experiments;
import com.wantedtech.common.xpresso.sentence.pos.en.stanford.FeatureKey;
import com.wantedtech.common.xpresso.sentence.pos.en.stanford.HistoryTable;
import com.wantedtech.common.xpresso.sentence.pos.en.stanford.TaggerFeature;
import com.wantedtech.common.xpresso.sentence.pos.en.stanford.TaggerFeatures;
...
private final Set<FeatureKey> sTemplates = Helpers.newHashSet();
...
private void getFeaturesNew() {
 ...
 try {
   ...
   for (FeatureKey fK : sTemplates) {
     int numF = fK.num;
     int[] xValues;
     tuple2<Integer, String> wT = tuple2.valueOf(numF, fK.val);
     ...
     for (int xValue : xValues) {
       ...
       if (maxentTagger.possibleTagsOnly) {
         ...
         Set<String> s = Helpers.newHashSet(Arrays.asList(maxentTagger.tags.deterministicallyExpandTags(tags)));
         if(DEBUG)
